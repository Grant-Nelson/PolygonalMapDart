...
class QuadTreePlotter extends plotter.Plotter {
    ...
    plotter.Rectangles addBound(plotter.Rectangles rects, qt.Boundary bound, double inset) {
        if (rects != null) {
            ...
            rects.add([bound.xmin.toDouble()-inset, bound.ymin.toDouble()-inset, bound.width.toDouble()-inset2, bound.height.toDouble()-inset2]);
        }
        return rects;
    }
    ...
    /// Adds a quad-tree to this plotter.
    void addTree(plotter.Group group, qt.QuadTree tree, [bool showPassNodes=true,
        bool showPointNodes=true, bool showEmptyNodes=false,bool showBranchNodes=false,
        bool showEdges=true, bool showPoints=true]) {
    ...
    void addTreeItems(qt.QuadTree tree, plotter.Rectangles passRects, plotter.Rectangles pointRects,
            plotter.Rectangles emptyRects, plotter.Rectangles branchRects,
            plotter.Lines edges, plotter.Points points) {
...
class QuadTreePlotterNodeHandler extends qt.INodeHandler {
    ...
    QuadTreePlotterNodeHandler(this._plot, this._passRects,
      this._pointRects, this._emptyRects, this._branchRects);
